...
const initObject = () => {
    ...
    //   const textMesh = new THREE.Mesh(textGeometry, meshMaterial)
      ...
      var meshMaterial = new THREE.PointsMaterial( { color: 0x29b6f6, size: 3,sizeAttenuation: false} )
      const textMesh = new THREE.Points(textGeometry, meshMaterial)
